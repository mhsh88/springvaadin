...
import ir.sharifi.spring.view.main.LoginView;
import ir.sharifi.spring.view.errors.AccessDeniedView;
import ir.sharifi.spring.view.errors.CustomRouteNotFoundError;
...
public final class SecurityUtils {
	...
	private static SecurityUserRepository userRepository;

	@Autowired
	private SecurityUtils(SecurityUserRepository userRepository) {
		// Util methods only
	...
	public static SecurityUser getUser(){
		return userRepository.getActiveUser(getUsername());
	}
